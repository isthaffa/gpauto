...
const slidesData = [
  {
    id: 1,
    image: assetPath("/assets/img/team/team_single_page_slider_1.jpg"),
    alt: "Slide 1",
  },
  {
    id: 2,
    image: assetPath("/assets/img/team/team_single_page_slider_2.jpg"),
    alt: "Slide 2",
  },
  {
    id: 3,
    image: assetPath("/assets/img/team/team_single_page_slider_3.jpg"),
    alt: "Slide 3",
  },
  {
    id: 4,
      ...
      <div className="team-single-page-slider ak-slider">
        ...
        <div className="team-single-page-swiper-controll">
          <div className="button-next button-style">
            <img src={assetPath("/assets/img/icon/prev.svg")} alt="Next" />
          </div>
          <div className="button-prev button-style">
            <img src={assetPath("/assets/img/icon/next.svg")} alt="Previous" />
          </div>
        </div>
      </div>
    </>
